...
export const useProgressStore = create<ProgressState>()(
  persist(
    ...
    }),
    {
      ...
      version: 2,
      partialize: (state) => ({
        // Only persist essential state — exclude heavy data like base64 images, chat history, security logs
        ...
        // Explicitly excluded: userBooks (base64 PDFs/images), chatMessages, securityAuditLog,
        // bookAccessSessions, registeredUsers (profilePictures), loginHistory, referralHistory,
        // bookReviews, readingProgress, bookNotes, bookmarkedBooks, purchasedCourses,
        // projects, savedResources, subscribedEmails, studyPlan, typedGame*, wordScramble*, etc.
      }),
